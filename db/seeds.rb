...
emergency_shelters = Tag.create(key: 'emergency_shelters', parent_id: tag.id)
Tag.create(key: 'cada', parent_id: tag.id)
Tag.create(key: 'cph', parent_id: tag.id)
minor = Tag.create(key: 'minor', parent_id: tag.id)
Tag.create(key: 'hotel_hostels', parent_id: tag.id)
Tag.create(key: 'calm', parent_id: tag.id)
trans = Tag.create(key: 'trans', parent_id: tag.id)
...
specialists = Tag.create(key: 'specialists', parent_id: tag.id)
...
before_asylum = Tag.create(key: 'before_asylum', parent_id: tag.id)
asylum_demand = Tag.create(key: 'asylum_demand', parent_id: tag.id)
refugee_rights = Tag.create(key: 'refugee_rights', parent_id: tag.id)
...
Tag.create(key: 'ambassador', parent_id: tag.id)
associations = Tag.create(key: 'associations', parent_id: tag.id)
...
PointOfInterest.create(
  ...
  latitude: 48.847532,
  longitude: 2.331333,
  tags: [before_asylum, refugee_rights, asylum_demand, associations],
