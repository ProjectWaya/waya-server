...
Tag.create(key: 'hc_cmu', parent_id: healthcare.id)
Tag.create(key: 'hc_ame', parent_id: healthcare.id)
...
Tag.create(key: 'hc_associations', parent_id: healthcare.id)
Tag.create(key: 'hc_minor', parent_id: healthcare.id)
...
Tag.create(key: 'ap_ame', parent_id: tag.id)
Tag.create(key: 'ap_cmu', parent_id: tag.id)
...
Tag.create(key: 'ent_associations', parent_id: tag.id)
...
associations = Tag.create(key: 'cont_associations', parent_id: contacts.id)
...
75 018 PARIS ",
        city: cities["paris"]   http://www.ldh-france.org 

  phone: "tél : 01 56 55 51 00 / fax : 01 56 55 51 21 ",  tags: [before_asylum,
asylum_demand,
refugee_rights,
cont_associations])
...
PointOfInterest.create(  key: 'guichet_unique_val_doise', latitude: 49.032142,  longitude: 49.032142, 2.078303, address: "5, avenue Bernard Hirsch, 95 010 Cergy-Pontoise ",        city: cities["paris"]       tags: [asylum_demand,ada])
...
PointOfInterest.create(  key: 'hopital_europeen_georges_pompidou',  latitude: 48.839385,  longitude: 2.273559,  address: "20, rue Leblanc – Paris 15e", opening_hours: "Consultations au sein du Service d’Accueil des urgences (SAU)",     city: cities["paris"]     phone: "01 56 09 20 00",  tags: [pass, specialists])
...
PointOfInterest.create(  key: 'centre_du_psychotrauma_de_linstitut_de_victimologie_de_paris', latitude: 48.888780,  longitude: 2.307901,  address: "131 rue de Saussure 75017 Paris ",        city: cities["paris"],      phone: "Tel. : 01 43 80 44 40 
Fax : 01 43 80 44 93",
  tags: [specialists])
